            ...
            <div className="footer__brand">
              <Link to="/" className="footer__logo">
                <svg viewBox="0 0 40 40" fill="none" width="36" height="36">
                  <path d="M20 4C26 4 34 12 34 22C34 30 28 36 20 36C12 36 6 30 6 22C6 12 14 4 20 4Z" fill="url(#footerLeafGrad)"/>
                  <path d="M20 4 L20 36" stroke="#c9a84c" strokeWidth="1" strokeDasharray="3,3"/>
                  <defs>
                    <linearGradient id="footerLeafGrad" x1="6" y1="4" x2="34" y2="36">
