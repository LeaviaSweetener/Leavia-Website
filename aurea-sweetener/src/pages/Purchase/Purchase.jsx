    ...
    <div className="purchase page-wrapper">
      ...
      <section className="section section--dark" style={{ paddingTop: '8rem', paddingBottom: '4rem', position: 'relative', overflow: 'hidden', background: 'var(--gradient-hero)' }}>
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
          <ScrollReveal>
            <span className="overline">Shop Leavia</span>
            ...
            <p style={{ color: 'rgba(255,255,255,0.6)', fontFamily: 'var(--font-serif)', fontSize: '1.05rem' }}>
              Free shipping over $30 · 30-day happiness guarantee
            </p>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="container">
          <div className="purchase__layout">
            ...
            <div className="purchase__products">
              <SectionTitle
                overline="Select Your Size"
                title="Find Your Perfect Jar"
                align="left"
                titleMaxWidth="400px"
              />
                  ...
                  <ScrollReveal key={p.id} delay={(p.id - 1) * 0.08}>
                    ...
                    >
                      ...
                      <div className="purchase__card-price">
                        ...
                        <span className="purchase__per-serving">${p.pricePerServing}/serving</span>
                      </div>
            ...
            <ScrollReveal direction="right">
              <div className="purchase__summary">
                <h3 className="purchase__summary-title">Your Order</h3>
                ...
                <div className="purchase__subscription">
                  <div className="purchase__subscription-info">
                    ...
                    <span>Delivered every 30 days. Cancel anytime.</span>
                  </div>
                  <button
                ...
                {isSubscription && (
                  <div className="purchase__sub-badge">
                    🎉 Subscription Discount Applied — 20% off every order!
                  </div>
                )}
                ...
                {Number(finalPrice) >= 30 && (
                  <p className="purchase__free-shipping">✓ Free shipping included!</p>
                )}
                ...
                >
                  {addedToCart ? (
                    ...
                    <>
                      {isSubscription ? 'Subscribe Now' : 'Add to Cart'} — ${finalPrice}
                    </>
                  )}
                ...
                <div className="purchase__guarantees">
                  {['30-Day Money-Back Guarantee', 'Secure Checkout', 'Ships in 24 Hours'].map((g, i) => (
